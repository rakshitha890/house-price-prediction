...
neighborhood = st.number_input("Neighborhood Quality (1-10)", min_value=1, max_value=10)

# Predict button
if st.button("Predict Price"):
    input_data = np.array([[sqft, bedrooms, bathrooms, year, lot, garage, neighborhood]])
